    ...
    <div className="overflow-y-auto h-full">
      ...
      <div className="sticky top-0 z-10 border-b border-hairline bg-canvas/80 backdrop-blur-sm">
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <button
            onClick={onClose}
            className="flex h-7 w-7 items-center justify-center rounded-[8px] text-sm text-muted transition-colors hover:bg-surface-card hover:text-ink"
          >
            ✕
          </button>
        </div>
      ...
      <article className="mx-auto w-full max-w-3xl px-8 py-8">
        ...
        {/* 내용 렌더링 */}
        {article.content_type === "written" && article.content_html ? (
          <div
